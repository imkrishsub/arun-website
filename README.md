...
Arun Murugan's personal site (`index.html`, English — the default — with German
at `de/index.html`; old `/en/` links redirect to `/`), plus the document generators that turn it into
print-ready PDFs.
