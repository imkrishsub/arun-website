...
NAME = "Arun Murugan"
STREET = ""
# No city is published any more: the letters name the country only, in the
...
def _default_date(lang: str) -> str:
    ...
    return f"{today:%d %B %Y}".replace(" 0", " ")
...
LOCALE = {
    "en": {
        ...
        "body": [
            ...
            "Hiring me costs nothing beyond the salary. I already live in Germany and "
            ...
            "I am based in Germany. My working language is "
    ...
    "de": {
        ...
        "body": [
            ...
            "Ich wohne in Deutschland. Meine Arbeitssprache ist "
